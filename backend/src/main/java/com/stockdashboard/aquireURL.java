...
public class aquireURL {
    // Declare static final variable for the API token
    ...
    private static String initializeApiToken() {
        ...
        try {
            ...
            token = System.getenv("THENEWSAPI_TOKEN"); // Use the environment variable name
        }
    ...
    private static String buildEndpoint(String query, String date) {
        return String.format(
                ...
                API_TOKEN, // Use the loaded token
    ...
    public static void main(String[] args) {
        ArrayList<String> articleUrls = getURLs("NVIDIA");
